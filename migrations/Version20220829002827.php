 ...
 */
final class Version20220829002827 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('CREATE TABLE element (id INT AUTO_INCREMENT NOT NULL, note_id INT DEFAULT NULL, nom VARCHAR(255) NOT NULL, photo VARCHAR(255) DEFAULT NULL, barre TINYINT(1) NOT NULL, INDEX IDX_41405E3926ED0855 (note_id), PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci` ENGINE = InnoDB');
        ...
        $this->addSql('CREATE TABLE share (id INT AUTO_INCREMENT NOT NULL, user_1_id INT NOT NULL, user_2_id INT NOT NULL, note_id INT NOT NULL, updated_at DATETIME NOT NULL COMMENT \'(DC2Type:datetime_immutable)\', seen TINYINT(1) NOT NULL, INDEX IDX_EF069D5A8A521033 (user_1_id), INDEX IDX_EF069D5A98E7BFDD (user_2_id), INDEX IDX_EF069D5A26ED0855 (note_id), PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci` ENGINE = InnoDB');
